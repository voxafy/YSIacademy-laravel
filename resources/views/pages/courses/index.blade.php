<section class="card" style="padding: 30px;">
    <div class="section-header">
        <div>
            ...
            <h1 class="section-title">Обучающие программы ЮСИ в СтройТех</h1>
            <p class="section-text">
                В каталоге собраны вводные, ролевые и контрольные программы по стандартам ЮСИ,
                работе в amoCRM, Allio и ключевым внутренним процессам компании.
            </p>
        </div>
    </div>
