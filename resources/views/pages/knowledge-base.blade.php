...
<section class="section-header kb-help-header">
    <div>
        ...
        <h1 class="section-title section-title--small">Справочник по работе в СтройТех</h1>
        <p class="section-text">Инструкции, правила, регламенты и ответы на частые вопросы собраны в одном спокойном интерфейсе без лишнего шума.</p>
    </div>
    <?php if ($isAdmin): ?>
            ...
            <article class="card kb-help-article">
                ...
                <?php if ($articles === []): ?>
                    <div class="kb-empty kb-empty--compact">
                        ...
                        <p>Попробуйте изменить формулировку вопроса, снять часть фильтров или перейти к полному содержанию базы знаний.</p>
                    </div>
                <?php else: ?>
        ...
        <?php elseif ($activeArticle !== null): ?>
            ...
            <details class="card kb-assistant kb-assistant--collapsed" data-kb-assistant data-endpoint="<?= e(url('/knowledge-base/assistant/search')) ?>">
                <summary class="kb-assistant__summary">
                    ...
                    <strong>Найти ответ по справочнику и учебным материалам</strong>
                </summary>
                <div class="kb-assistant__body">
                    <form class="kb-assistant__form" data-kb-assistant-form>
                        <label class="field">
                            <span class="field__label">Вопрос</span>
                            <input class="input" type="search" name="q" data-kb-assistant-input placeholder="Например: как проверить дубль клиента или что зафиксировать после звонка">
                        </label>
                        <div class="kb-help-search__actions">
