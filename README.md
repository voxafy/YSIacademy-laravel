# Академия ЮСИ / Laravel

Laravel-миграция действующей корпоративной академии ЮСИ. Новый проект собран в отдельной папке и сохраняет ключевые сценарии исходной системы:
